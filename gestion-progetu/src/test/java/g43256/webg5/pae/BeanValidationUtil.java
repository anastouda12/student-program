...
public class BeanValidationUtil<T> {
    ...
    /**
     * Teste qu'une entité est bien valide. Le test qui appelle cette méthode échoue
     * si l'entité n'est pas valide.
     * 
    ...
    /**
     * Teste qu'une entité possède une violation de contrainte. Le test qui appelle
     * cette méthode échoue si l'entité viole la contrainte indiquée par les
     * paramètres et uniquement celle-là.
     * 
